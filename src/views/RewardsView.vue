...
import Banner from "@/components/rewardsview/Banner.vue";
import HeroSection from "@/components/rewardsview/HeroSection.vue";
...
import KeepRewards from "@/components/rewardsview/KeepRewards.vue";
